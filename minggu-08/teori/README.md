...
Modul locale mengakses database dengan format data yang spesifik. Atribut pengelompokan fungsi format milik lokal menyediakan cara untuk memformat angka dengan pemisah grup :
